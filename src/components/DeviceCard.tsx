    ...
    <div className="glass-card group p-6 flex flex-col items-center text-center transition-all duration-500 relative border-white/5 h-full min-h-[400px]">
      ...
      <div className="mt-auto w-full space-y-2">
        <Button 
          ...
          variant="outline" 
          className="w-full font-headline font-medium tracking-widest bg-white/5 border-white/10 hover:bg-white/5 hover:border-primary/50 hover:shadow-[0_0_15px_rgba(139,92,246,0.2)] text-slate-300 transition-all duration-300 rounded-xl h-10 text-[10px]"
        >
        ...
        <Button 
          asChild 
          variant="outline" 
          className="w-full font-headline font-medium tracking-widest bg-primary/5 border-primary/20 hover:bg-primary/5 hover:border-primary/60 hover:shadow-[0_0_15px_rgba(139,92,246,0.3)] text-slate-300 transition-all duration-300 rounded-xl h-10 text-[10px]"
        >
      ...
      <div className={cn(
        ...
        <Button 
          ...
          className="mt-4 bg-primary/5 border border-primary/20 text-slate-300 hover:bg-primary/5 hover:border-primary/60 hover:shadow-[0_0_15px_rgba(139,92,246,0.3)] rounded-xl font-headline font-medium h-10 text-[10px] tracking-widest transition-all duration-300 shrink-0"
        >
          BACK
        </Button>
      </div>
